...
public class ProductController implements Initializable {
    ...
    public void buy(ActionEvent event) throws IOException {
     ...
     // If addtocart button is pressed, set product status to true
        if (sourceButton.equals(p1)) {
            ...
            HomeController.product1.setProductQuantity(6);
            HomeController.cart.addItem(HomeController.cartController.pane6);
        }

        else if (sourceButton == p7) {
            HomeController.product7.setProductStatus(true);
            HomeController.product1.setProductQuantity(7);
            HomeController.cart.addItem(HomeController.cartController.pane7);
        }

        else if (sourceButton == p8) {
            HomeController.product8.setProductStatus(true);
            HomeController.product1.setProductQuantity(8);
            HomeController.cart.addItem(HomeController.cartController.pane8);
        }
    ...
    public void gotoCart(ActionEvent event) throws IOException {
        ...
        HomeController.cartController.showItems(ProductController.cart.getItemList());
